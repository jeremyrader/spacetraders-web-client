    ...
    <div className="card shadow-xl">
      <div className="card-body">
        ...
        <ul className="menu menu-vertical lg:menu-horizontal bg-base-200 rounded-box mb-2">
          <li>
            <a
              className={`${selectedLeaderBoard === 'Credits' ? 'bg-base-300' : 'bg-base-200'}`}
              onClick={() => {
                setSelectedLeaderBoard('Credits');
              }}
            >
              Credits
            </a>
          ...
          <li>
            <a
              className={`${selectedLeaderBoard === 'Charts' ? 'bg-base-300' : 'bg-base-200'}`}
              onClick={() => {
                setSelectedLeaderBoard('Charts');
              }}
            >
